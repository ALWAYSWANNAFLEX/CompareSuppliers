...
7. Убери коды регионов: AE, CA, EU, RU, US, SEA, EAC, IN и т.д. в конце названия.
8. Убери эмодзи флагов: 🇨🇦, 🇺🇸, 🇷🇺, 🇪🇺 и т.д.
9. WAЖНО для смартфонов/телефонов: ОЗУ должно быть указано ОБЯЗАТЕЛЬНО. Если в исходном названии ОЗУ не указано, определи его по официальным характеристикам этой модели (ты знаешь спецификации популярных смартфонов). Например: Google Pixel 11 Pro XL всегда имеет 12 ГБ ОЗУ, iPhone 15 Pro Max — 8 ГБ, Samsung Galaxy S24 Ultra — 12 ГБ и т.д.
10. Формат "4+128GB" → "4/128" (убери GB, замени + на /)
11. Формат "4/128GB" → "4/128" (убери GB)
...
- "iPhone 16 Pro 256 Desert🇷🇺" → "Apple iPhone 16 Pro 8/256 Desert"

ЗАПРЕЩЕНО:
- Оставлять оригинальное название без изменений
- Возвращать название в том же формате, что получено на вход
- Пропускать стандартизацию для любого товара`;
